...
use App\Http\Requests\Md_messageRequest as StoreRequest;
use App\Http\Requests\Md_messageRequest as UpdateRequest;

class Md_messageCrudController extends CrudController
{
