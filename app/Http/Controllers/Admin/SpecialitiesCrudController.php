...
use App\Http\Requests\SpecialitiesRequest as StoreRequest;
use App\Http\Requests\SpecialitiesRequest as UpdateRequest;

class SpecialitiesCrudController extends CrudController
{
