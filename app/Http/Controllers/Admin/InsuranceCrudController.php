        ...
        */
        ...
        //$this->crud->setFromDb();
         ...
         $this->crud->addColumn([
           'label' => "Centers",
           'type' => 'select',
           'name' => 'centers_id', // the db column for the foreign key
           'entity' => 'get_all_centers', // the method that defines the relationship in your Model
        ...
        $this->crud->addColumn([
           ...
           'type' => 'select',
           'name' => 'insurance_category_id', // the db column for the foreign key
           'entity' => 'get_all_insurance_category', // the method that defines the relationship in your Model
           'attribute' => 'title', // foreign key attribute that is shown to user
           'model' => "App\Models\Insurance_Category" // foreign key model
        ]);
