...
$(document).scroll(function() {
	  ...
	  if(baseUrl == "index.html"){
		  ...
		  if (y > os_offsetop) {
			...
			/*setTimeout(function(){ $('.osbox1').stop().addClass("anim"); }, 500);
			setTimeout(function(){ $('.osbox2').stop().addClass("anim"); }, 700);
			setTimeout(function(){ $('.osbox3').stop().addClass("anim"); }, 900);
			setTimeout(function(){ $('.osbox4').stop().addClass("anim");  }, 1100);*/
		 ...
		 var rainbow_offsetop = $('.kaleidoscopewrp').offset().top - 100;
		  if(y > rainbow_offsetop){
			...
			/*setTimeout(function(){ $('.rbbox1').stop().addClass("anim"); }, 500);
			setTimeout(function(){ $('.rbbox2').stop().addClass("anim"); }, 600);*/
		  }
...
$(window).on('load', function(){
	$('.circuleframe, .circuleframe2').addClass('active');
});
